...
func (c *App) execGroupChatAddJoinWay(req GroupChatAddJoinWayReq) (GroupChatAddJoinWayResp, error) {
	var resp GroupChatAddJoinWayResp
	err := c.executeWXApiJSONPost("/cgi-bin/externalcontact/groupchat/add_join_way", req, &resp, true)
	if err != nil {
		return GroupChatAddJoinWayResp{}, err
	}

	if bizErr := resp.TryIntoErr(); bizErr != nil {
		return GroupChatAddJoinWayResp{}, bizErr
	}

	return resp, nil
}

func (c *App) execGroupChatGetJoinWay(req GroupChatGetJoinWayReq) (GroupChatGetJoinWayResp, error) {
	var resp GroupChatGetJoinWayResp
	err := c.executeWXApiJSONPost("/cgi-bin/externalcontact/groupchat/get_join_way", req, &resp, true)
	if err != nil {
		return GroupChatGetJoinWayResp{}, err
	}
	if bizErr := resp.TryIntoErr(); bizErr != nil {
		return GroupChatGetJoinWayResp{}, bizErr
	}
	return resp, nil
}

func (c *App) execGroupChatUpdateJoinWay(req GroupChatUpdateJoinWayReq) (CommonResp, error) {
	var resp CommonResp
	err := c.executeWXApiJSONPost("/cgi-bin/externalcontact/groupchat/update_join_way", req, &resp, true)
	if err != nil {
		return resp, err
	}
	if bizErr := resp.TryIntoErr(); bizErr != nil {
...
func (c *App) execGroupChatDelJoinWay(req GroupChatDelJoinWayReq) (CommonResp, error) {
	var resp CommonResp
	err := c.executeWXApiJSONPost("/cgi-bin/externalcontact/groupchat/del_join_way", req, &resp, true)
	if err != nil {
		return resp, err
	}
