...
var _ bodyer = ListContactWayReq{}

func (x ListContactWayReq) intoBody() ([]byte, error) {
	result, err := json.Marshal(x)
	if err != nil {
		return nil, err
	}
...
var _ bodyer = listContactWayResp{}

func (x listContactWayResp) intoBody() ([]byte, error) {
	result, err := json.Marshal(x)
	if err != nil {
		return nil, err
	}
...
func (c *App) execListContactWay(req ListContactWayReq) (listContactWayResp, error) {
	var resp listContactWayResp
	err := c.executeWXApiJSONPost("/cgi-bin/externalcontact/list_contact_way", req, &resp, true)
	if err != nil {
		return listContactWayResp{}, err
	}
	if bizErr := resp.TryIntoErr(); bizErr != nil {
		return listContactWayResp{}, bizErr
	}
